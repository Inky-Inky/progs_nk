...
//Inky 20201010 Additional custom entities
float ENT_SIGN_LEFT				= 92;
float ENT_SIGN_RIGHT			= 93;
float ENT_TANKARD				= 94;
float ENT_GOBLET				= 95;
float ENT_CLEAVER				= 96;
...
//float entity_spawnvalues[552] =//6 per entity //Inky 20201010 Additional custom entities
float entity_spawnvalues[582] =//6 per entity
{  // Health    Mass    Movetype         Solid    Thingtype        DamageType
	  ...
	  1000,	 2000,	    4,				3,				9,				1,	// ENT_STATUE_TUT
	   ...
	   150,	    8,	    4,				3,			    4,				1,	// ENT_MUMMY monster
	    80,	   12,	    4,				3,			    4,				1,	// ENT_ARCHER monster
	   ...
	   150,	  500,	    0,				3,			    1,				1,	// ENT_STATUE_ANGEL
	    25,	    3,	    4,				3,			    4,				1,	// ENT_SHEEP monster
	   ...
	   100,	   10,	    5,				3,			    4,				1,	// ENT_FANGEL monster
	  ...
	  9999,	  100,	    4,				3,			    2,				1,	// ENT_BUDDHA monster
...
//Inky 20201010 Additional custom entities
		25,	99999,	    0,				2,				2,				1,	// ENT_SIGN_LEFT
		25,	99999,	    0,				2,				2,				1,	// ENT_SIGN_RIGHT
		10,	  100,	    4,				5,			   17,				1,	// ENT_TANKARD
		10,	  100,	    4,				5,				3,				1,	// ENT_GOBLET
		10,	  100,	    4,				5,				3,				1	// ENT_CLEAVER
};//Health    Mass    Movetype         Solid    Thingtype        DamageType
...
//vector entity_box[184] = //Inky 20201010 Additional custom entities
vector entity_box[194] = 
{   // Min             Maxs
...
//Inky 20201010 Additional custom entities
	' -10  -24    0',	' 10  24  60',			// ENT_SIGN_LEFT
	' -10  -24    0',	' 10  24  60',			// ENT_SIGN_RIGHT
	'  -5   -5    0',	'  5   5  20',			// ENT_TANKARD
	'  -5   -5    0',	'  5   5  16',			// ENT_GOBLET
	'  -8   -8    0',	'  8   8  20'			// ENT_CLEAVER
};
