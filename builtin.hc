...
float vectoyaw2(vector v, float f) : 13; //Inky 20201228 High precision variant
...
vector vectoangles2(vector v, float f) : 51; //Inky 20201228 High precision variant
...
//Inky: custom centerprint hiding original one
//void centerprint(entity client, string s) : 73;
void original_centerprint(entity client, string s) : 73;
