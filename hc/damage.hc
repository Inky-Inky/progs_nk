...
{
entity oself;
	activator = self.enemy; //Inky 20211011 Previously at the end of monster_death_use where it was commented out to prevent double target firing upon monster death
	oself = self;
	self = targ;
