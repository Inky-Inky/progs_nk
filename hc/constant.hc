...
float PZ_VIAL =     58;
float PZ_GOLDGEM =  59;
float PZ_GREENGEM = 60;
float PZ_REDGEM =   61;
float PZ_LBUDDA =   62;
float PZ_DTONGUE =  63;
float PZ_SCROLL =   64;
float PZ_DUKESEAL = 65;
float PZ_PRAYER2 =  66;
float PZ_CROSSKEY = 67;
float PZ_HEADKEY =  68;
float PZ_TBTMASK =  69;
float PZ_SCEPTER =  70;
float PZ_ORB =      71;
...
float FL_TELEPORTABLE			= 8192;		// make the thing susceptible of being teleported away by trigger_stealth_teleport although being normally ignored (misc_model, model train...). Might be useful in other circumstances.
...
float	SVC_CENTERPRINT				= 26; //Inky 20210907 Not used in vanilla HexenC, yet implemented in the engine
...
// entity effects
float	EF_BRIGHTFIELD				= 1;	//No effect (?)
float	EF_MUZZLEFLASH 				= 2;	//No effect (?)
float	EF_BRIGHTLIGHT 				= 4;	//Flicker
float	EF_TORCHLIGHT				= 6;	//Flicker
float	EF_DIMLIGHT 				= 8;	//Flicker
float	EF_DARKLIGHT				= 16;	//Black light
float	EF_DARKFIELD				= 32;	//St Elmo
float	EF_LIGHT					= 64;	//Still light
float	EF_NODRAW					= 128;
float   EF_TEX_STOPF				= 256;
float	EF_TEX_STOPL				= 512;
...
float	SFL_CROSS_TRIGGER_9  = 65536;
float	SFL_CROSS_TRIGGER_10 = 131072;
float	SFL_CROSS_TRIGGER_11 = 262144;
float	SFL_CROSS_TRIGGER_12 = 524288;
float	SFL_CROSS_TRIGGER_13 = 1048576;
float	SFL_CROSS_TRIGGER_14 = 2097152;
float	SFL_CROSS_TRIGGER_15 = 4194304;
float	SFL_CROSS_TRIGGER_16 = 8388608;
