...
void() monster_use =
{
	...
	if (activator.flags & FL_NOTARGET)
		return;
	if (activator.netname != "traitor") //Inky 20200808 To allow infighting (ex.: the archers in Valley turn against the yakman)
	{
		if (self.enemy)
			return;
...
// fall to ground
	...
	/*Inky 20211011 Commented out to prevent double target firing upon monster death because MakeSolidCorpse (normal death) and chunk_death (instagib) already trigger targets
