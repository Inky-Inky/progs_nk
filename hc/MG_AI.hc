...
float okay;
	...
	if(self.controller.enemy!=world&&self.controller.enemy.flags2&FL_ALIVE&&visible(self.controller.enemy)&&self.controller.enemy.model!="models/sheep.mdl")
	{
			...
			if(found.flags2&FL_ALIVE)
				if(visible(found))
					if(found!=self.controller)
						...
						if(found.controller!=self.controller&&found.model!="models/sheep.mdl")
						{
							if(coop)
							{
