...
void() func_button =
{
	...
	//Inky 20201103 Hexen switches sounds
	if (self.soundtype == 4)
	{
		precache_sound ("buttons/chnswch8.wav");
		self.noise = "buttons/chnswch8.wav";
	}
	if (self.soundtype == 5)
	{
		precache_sound ("buttons/swtchrp1.wav");
		self.noise = "buttons/swtchrp1.wav";
	}	
	SetMovedir ();
