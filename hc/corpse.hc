...
void corpseblink (void)
{
	...
	if (self.scale < 0.10)
	{
		if(self.movechain) //Inky 20201204 To remove its wanderlust entity if any
...
//value set in spawn
	...
	//Inky 20211011 Those 3 lines added because target firing was commented out at the end of monster_death_use where it could cause double target firing upon monster death
