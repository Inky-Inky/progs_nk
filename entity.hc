...
.float cnt_haste;			// Count of inventory item - White Servant instead of Haste (Inky)
...
// Puzzle Item
.string puzzle_id;
.float puzzle_item; //Inky: an easier to use alternative to puzzle_id
...
//
// switchable shadow 	/*20210703 bmFbr's shadows code*/
// 
.float		switchshadstyle;
.float		shadowoff;
.entity		shadowcontroller;

//Inky 20211104 Used by misc_modelpimper
.vector glow_color;

//Inky 20211111 Used by liquid trains
.float watertime
.float watershift;
.float zerogtime;
