/*
 * $Header: /H2 Mission Pack/HCode/torch.hc 18    3/03/98 4:36p Jmonroe $
 */
/*
==========================================================
TORCH.HC
...
void light_candle1 (void)
{
	...
	//Inky 20201101 Custom ambient sound
	precache_sound ("ambience/candle.wav");
	ambientsound (self.origin, "ambience/candle.wav", 0.5, ATTN_STATIC);
...
void light_burner (void)
{
	...
	if(self.spawnflags&1) self.movechain.effects (+) EF_NODRAW; else makestatic (self.movechain);
